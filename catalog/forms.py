...
class ProductForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        """1) Добавляем CSS-классы ко всем полям формы. 2) Убираем параметр 'help_text' для всех полей, чтоб это
        больше не выводилось автоматически по умолчанию на html-странице. 3) Убираем поле 'is_published' так как
        это доступно только модератору по отдельным реализованным кнопкам."""
